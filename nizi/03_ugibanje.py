...
def preberi_celo_stevilo():
    n = input("> Vnesi celo število: ")
    if n.isdigit():
        return int(n)
    elif n[0] == '-' and n[1].isdigit():
        return int(n)
    else:
        print(f'Žal "{n}" ni celo število, poskusi ponovno!')
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NiwidXNlciI6MTE1MTR9:1vyvM1:aaMXCU6s3VKGLJL5En_uR7sigQ0rRDRnTk5r7KwLpOo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NywidXNlciI6MTE1MTR9:1vyvM1:ZSB1Rc2BEjpqZnU0GwW7Ld0cpzdiySMSQZZ-Dw7r2xM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyMywidXNlciI6MTE1MTR9:1vyvM1:ckJY0SGzpAuRJtfTLEvMH-9GPw-LyY9Kza9kfZaLsYg"
        try:
