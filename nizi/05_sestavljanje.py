...
#     "-RACUN---0000010\nCena: 50 EUR\nDDV: 11\nSkupno: 61\nHvala za obisk"
# =============================================================================
def turist(račun, cena, ddv):
    s = cena * (1 + (ddv / 100))
    d = s - cena
    return f"-RACUN---{račun:07}\nCena: {cena} EUR\nDDV: {d:.0f}\nSkupno: {s:.0f}\nHvala za obisk"
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MywidXNlciI6MTE1MTR9:1vyvM1:4G5Bep4GPv31K2t5yTf5Ssre6QD-IAFGHvxXGxfC8b4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NCwidXNlciI6MTE1MTR9:1vyvM1:TQKtOZ_KETzKgQ9hMlZpx-cOzb-1IVE7bfVveFcyEFc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NSwidXNlciI6MTE1MTR9:1vyvM1:_IOcy9bRgsqDMdaioHP8N9N2FBWbGRTKEH3UXHGmEoY"
        try:
