...
def je_palindrom(niz):
    return niz.lower() == prezrcali(niz).lower()
# =====================================================================@027483=
# 3. podnaloga
...
def odstrani_samoglasnike(niz):
    if "a" or "e" or "i" or "o" or "u" in niz.lower():
        return niz.lstrip("AEIOUaeiou")

"""def odstrani_samoglasnike(niz):
    samoglasniki = "aeiouAEIOU"
    return niz.lstrip(samoglasniki)"""
# =====================================================================@027484=
# 4. podnaloga
...
def obrni_oklepaje(niz):
    niz.replace("(","x").replace(")","(").replace("x",")")
...
def prestej_posebno(niz, c, k):
    if k == 0:
        ...
        if i == -1:
            ...
            return prestej_posebno(niz[i+1:], c, k-1)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MSwidXNlciI6MTE1MTR9:1vyvM1:WiCDsJGWZBAAi_kpqZed3A6PNsq0cVCZB0oK24E1ELg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MiwidXNlciI6MTE1MTR9:1vyvM1:AdMlxP5fTxVWo0wrbHajfHj3eD6IIe7ckEvqdCS4U1o"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4MywidXNlciI6MTE1MTR9:1vyvM1:LeDTeW8eRhKgU240EZd16A_kz-zyHbv4lueG-VXsKrA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NCwidXNlciI6MTE1MTR9:1vyvM1:Js8fkWeeH9Fb0bJTqJOHQ6FdOFnwhsboYr8nj3gj8lY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NSwidXNlciI6MTE1MTR9:1vyvM1:Sxu3a_GDV1ZLwDxt9a1RCKcTfEz5ZAPyJ2NiBlDS-HM"
        try:
