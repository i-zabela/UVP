...
def ali_ima_enkratne_stevke(n):
    if n < 10:
        ...
        k = n % 10
        if kolikokrat_se_pojavi_stevka(k, n) > 1: 
            return False
        else: 
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNSwidXNlciI6MTE1MTR9:1vx45p:I3Ave6XWf22ztfD90zzzzUpDPj29AP3E3iIXcZmWx-U"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNiwidXNlciI6MTE1MTR9:1vx45p:fVFLH_1Bhez9MTBTFEIqSkBCvrbipp6VoR7M3i_E9Gk"
        try:
