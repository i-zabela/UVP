...
def vsota_vecjih_stevk(n, k=0):
    if n == 0:
        ...
        return n % 10 + vsota_vecjih_stevk(n // 10, k=k)
    else:
        return vsota_vecjih_stevk(n // 10, k=k)
# =====================================================================@000958=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTYsInVzZXIiOjExNTE0fQ:1vx45p:jqzpQgnrQtIJaULiv715wz92sWZRFR5ZH6YDU7W4MS0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTcsInVzZXIiOjExNTE0fQ:1vx45p:z3_L6IR35yizl9cunRjQP7oiVJQ5DXpGVcYf5Z8Qzfw"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTgsInVzZXIiOjExNTE0fQ:1vx45p:acHmMzW8xm7eAHiuiH95yxXcjcQDykIkkpRoSDWO6Hk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTksInVzZXIiOjExNTE0fQ:1vx45p:LDjRrmVRMphLN9pWYNHFHN8jajsjPP4NFYbu9fM751k"
        try:
            for i in range(1, 100):
