...
def vsota_prvih_potenc(n, k=1):
    if n == 0:
        ...
        return n**k + vsota_prvih_potenc(n-1, k=k)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTMsInVzZXIiOjExNTE0fQ:1vx45p:qAlvAQfp33Qcfay_LylWW4ccI5ud92La2p0HHSn8JnU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTQsInVzZXIiOjExNTE0fQ:1vx45p:Z9wZB6icqPiGoACmU2YUPxtcR2hgihTdRVOvhVu73Gc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTUsInVzZXIiOjExNTE0fQ:1vx45p:fqrDJCRbjHHNlo7K7tuJm7TKtbO6lN9xiT63iQS6ETY"
        try:
            try:
