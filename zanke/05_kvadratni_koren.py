...
def priblizek_po_korakih(n, k):
    približek = n / 2
    for i in range(k):
        približek = (približek + n / približek) / 2
    return približek
# =====================================================================@001004=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAzLCJ1c2VyIjoxMTUxNH0:1wxUit:HfGNoM5GWCflxeqpvAWFof7shOQfCe5emRBjV9X3ZDs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDA0LCJ1c2VyIjoxMTUxNH0:1wxUit:M-evPK3ZaohI3m0AktjITiFi4DDakp-1Zi53C3k6K0o"
        try:
