...
# =============================================================================
def pravilni_del_gesla(geslo, do_sedaj_ugibane_črke):
    rezultat = ""
    for črka in geslo:
        if črka in do_sedaj_ugibane_črke:
            rezultat = rezultat + črka
        else:
            rezultat = rezultat + "_"
    return rezultat
# =====================================================================@024176=
...
#     'j?'
# =============================================================================
def nepravilni_ugibi(geslo, do_sedaj_ugibane_črke):
    nepravi_ugibi = ""
    for črka in do_sedaj_ugibane_črke:
        if črka in geslo:
            continue
        else:
            nepravi_ugibi = nepravi_ugibi + črka
    return nepravi_ugibi
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NSwidXNlciI6MTE1MTR9:1wxUit:TzZUxgcgQwOk93867fj7OnP-3f2zPOFm8Kh_rlEnc-8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NiwidXNlciI6MTE1MTR9:1wxUit:XYU_CBEh_5i1npEVLgE-I5oVwCAWCwUvml2WiWvkotg"
        try:
