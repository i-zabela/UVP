...
# =============================================================================
def vsota_stevk(število):
    vsota = 0  
    while število > 0:
        vsota = vsota + število % 10
        število = število // 10
    return vsota

def vsota_stevk(število):
    vsota = 0
    for znak in str(število):   # pretvorimo v niz, da lahko iteriramo
        vsota = vsota + int(znak)  # znak pretvorimo nazaj v število
    return vsota
# =====================================================================@000982=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODEsInVzZXIiOjExNTE0fQ:1wxUit:gimnmEanpc3b-frnUczD_bnC09y7nEBHZJxqTzYU5nU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODIsInVzZXIiOjExNTE0fQ:1wxUit:3ZaTbr36aQ4Jlc6aRsyTRvoZe2vfef3QMs4GjsTODjk"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODMsInVzZXIiOjExNTE0fQ:1wxUit:Di65eeftBtOIr90Z3Sb_XvKKdsX3UELZXFJm4UlsdPM"
        try:
