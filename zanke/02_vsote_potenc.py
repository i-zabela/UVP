...
def vsota_prvih_kvadratov(n):
    ...
    vsota_kvadratov = 0
    while i <= n:
        vsota_kvadratov = vsota_kvadratov + i ** 2 
        i = i + 1
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzgsInVzZXIiOjExNTE0fQ:1wxUit:Jkm9tnFbxhIW-_NgutDrTQwb15x0hU6VWZzvWwdjAy8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzksInVzZXIiOjExNTE0fQ:1wxUit:Pd-lOcQFVNRph7dbc2jVRCYXfsUsRPl0UJLJ5yzl570"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODAsInVzZXIiOjExNTE0fQ:1wxUit:4bDziyQKdhSXZ9cremTBmlj5a6zrvtxNFUlB8yTxQyA"
        try:
            try:
