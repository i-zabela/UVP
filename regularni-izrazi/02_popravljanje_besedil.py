...
def poenostavi(naloga):
    vzorec = r'(\-*\d+\,*\d*)'
    return re.sub(vzorec, r'10', naloga)
...
def enote_na_konec(besedilo):
    vzorec = r'(€|\$) ?(\d+)'
    return re.sub(vzorec, r'\2 \1', besedilo)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDA5MywidXNlciI6MTE1MTR9:1x2pDO:MI7G9feoAo_NP3EQHKOzaAAJUteG0YeWaCZ3VYhn86o"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMiwidXNlciI6MTE1MTR9:1x2pDO:wYeeiAq8mnt3swfzErJnoY2DqFOxIRYIrwI3QH5bAMk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjozMzQwMywidXNlciI6MTE1MTR9:1x2pDO:FQaMPhjiIlTO5M9vUXJiJAWFRJmIQVfjw6sRhIGGXI8"
        try:
            Check.equal(
                'enote_na_konec("Cena kave je € 2, cena čaja pa €3.")',
                "Cena kave je 2 €, cena čaja pa 3 €."
