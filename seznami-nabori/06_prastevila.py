...
#     [2, 3, 5, 7]
# =============================================================================
def prastevila_do(št):
    praštevila = []
    for i in range(2, št + 1):
        praštevilo = i
        for j in range(2, i):
            if (i%j==0):
                praštevilo = False
        if praštevilo:
            praštevila.append(praštevilo)
    return praštevila
# =====================================================================@009811=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODA5LCJ1c2VyIjoxMTUxNH0:1wyX5Y:Bc0uBPvWLQfKlxBdzdAVpKJeqUl9psMrs_sjdHsXpSk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODEwLCJ1c2VyIjoxMTUxNH0:1wyX5Y:1GXiZWFDT4AOtEBU-9D72Z6NNIwUZ9oyVGF7OV-n2lw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODExLCJ1c2VyIjoxMTUxNH0:1wyX5Y:PvYK2lLG2NvqmzU9g0onQSy4PVXfK4Q9MFfuDUfOUWM"
        try:
