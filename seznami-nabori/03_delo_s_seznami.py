...
def zamenjaj_elementa(sez, i, j):
    k = len(sez)
    if 0 <= i < j < k:
        return sez[:i] + [sez[j]] + sez[i + 1:j] + [sez[i]] + sez[j + 1:]
    elif 0 <= j < i < k:
        return sez[:j] + [sez[i]] + sez[j + 1:i] + [sez[j]] + sez[i + 1:]
    else:
        return sez
# =====================================================================@009771=
# 3. podnaloga
...
def porezani_podseznami(sez):
    if sez == []:
        ...
        return [sez] + porezani_podseznami(sez[1:])
# =====================================================================@009812=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzY5LCJ1c2VyIjoxMTUxNH0:1wyX5Y:0OSoKLmu9PhELeXiW8P4ZjJv4fdVCF01HdPlB5I3cXM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzcwLCJ1c2VyIjoxMTUxNH0:1wyX5Y:8moJ4uFl019iacPDONaBHa2sD4R_a3ve5SC3TmSaSik"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NzcxLCJ1c2VyIjoxMTUxNH0:1wyX5Y:sNHW6o25-Xh6U1Vi0Y-U9x-CvnTKPgr99w16uyCXOKs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODEyLCJ1c2VyIjoxMTUxNH0:1wyX5Y:wO20STpXoTfXtR2H9Fm3_MVQ0xPjuxWCjRByLqvhw-A"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDExNiwidXNlciI6MTE1MTR9:1wyX5Y:oltYOsvV98oTi5GSd9jDchfKe_4DRZ1WTRYhhwp_mgs"
        try:
