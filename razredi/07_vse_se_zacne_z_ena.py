...
def poglej_in_povej():
    ...
    while True:
        yield niz
        naslednji = ""
        for znak, skupina in groupby(niz):
            dolzina = len(list(skupina))
            naslednji += str(dolzina) + znak
        niz = naslednji
# =====================================================================@001929=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTI4LCJ1c2VyIjoxMTUxNH0:1x1L4S:9dAa9omh73w422G2LA0yB-0p1_CwAI2pjnpp7WGibsc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTI5LCJ1c2VyIjoxMTUxNH0:1x1L4S:u60SAVQdbQWIDAt48BSo6rEldKmptQsmHHRmNQpj1Lg"
        try:
